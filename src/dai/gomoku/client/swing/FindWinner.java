...
public class FindWinner {
	...
	char renjuBoard [][] = new char [15][15]; // Get this declaration right, syntactically if it has an error...

	// Here that board above is used for the parameter... 
	public char hasSomeOneWon (char [][] board) {
	      ...
	      for (countY = 0; countY < 15; countY++) {
	         ...
	         if (onSpot == 'X' || onSpot == 'O') {            
	            ...
	            for (i = 0; i < 8; i++) {
	               ...
	               if (step == 5) { // counted to the end, while within board and within same flavour... 5 in a row.
